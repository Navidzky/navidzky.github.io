...
\begin{tight}
  \item NABE Transfer Pricing / Economic Measurement Conference (TEC2026) \hfill 2026 (submitted)
...
\role{Instructor --- Outstanding Teaching Award}{Purdue University}

\entry{ECON 252 Principles of Macroeconomics (Undergraduate)}{Summer 2025}
\role{Instructor --- Distinguished Teaching Award}{Purdue University}
...
MATLAB, R, Python, STATA, \LaTeX\par\vspace{0.3em}
Structural modeling, numerical equilibrium computation, simulation-based methods, large-scale
administrative and high-frequency vessel-tracking data (IMF PortWatch, ArcGIS/API pipelines).
